...
Metadata in CheersAI allows users to add custom fields to datasets and documents,
...
The MetadataService is a critical component in the CheersAI platform's metadata
