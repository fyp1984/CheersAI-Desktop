...
if [ -z "${NEXT_PUBLIC_API_PREFIX:-}" ]; then
...
if [ -z "${NEXT_PUBLIC_PUBLIC_API_PREFIX:-}" ]; then
...
export NEXT_PUBLIC_NEXUS_API_PREFIX=${NEXT_PUBLIC_NEXUS_API_PREFIX}
export NEXUS_API_BASE_URL=${NEXUS_API_BASE_URL}
export NEXT_PUBLIC_DESKTOP_SSO_LOGIN_URL=${NEXT_PUBLIC_DESKTOP_SSO_LOGIN_URL}
export NEXT_PUBLIC_DESKTOP_SSO_CLIENT_ID=${NEXT_PUBLIC_DESKTOP_SSO_CLIENT_ID}
export NEXT_PUBLIC_DESKTOP_SSO_PROTOCOL=${NEXT_PUBLIC_DESKTOP_SSO_PROTOCOL}
export NEXT_PUBLIC_DESKTOP_SSO_ENABLED=${NEXT_PUBLIC_DESKTOP_SSO_ENABLED}
export DESKTOP_SSO_CLIENT_SECRET=${DESKTOP_SSO_CLIENT_SECRET}
