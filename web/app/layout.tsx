...
const LocaleLayout = async ({
  ...
  const datasetMap: Record<DatasetAttr, string | undefined> = {
    ...
    [DatasetAttr.DATA_NEXUS_API_PREFIX]: process.env.NEXT_PUBLIC_NEXUS_API_PREFIX,
    ...
    [DatasetAttr.DATA_PUBLIC_DESKTOP_SSO_LOGIN_URL]: process.env.NEXT_PUBLIC_DESKTOP_SSO_LOGIN_URL,
    [DatasetAttr.DATA_PUBLIC_DESKTOP_SSO_CLIENT_ID]: process.env.NEXT_PUBLIC_DESKTOP_SSO_CLIENT_ID,
    [DatasetAttr.DATA_PUBLIC_DESKTOP_SSO_PROTOCOL]: process.env.NEXT_PUBLIC_DESKTOP_SSO_PROTOCOL,
    [DatasetAttr.DATA_PUBLIC_DESKTOP_SSO_ENABLED]: process.env.NEXT_PUBLIC_DESKTOP_SSO_ENABLED,
  ...
  return (
    <html lang={locale ?? 'en'} className="h-full" suppressHydrationWarning>
      <head>
        {/* Next.js 13+ app directory supports dynamic manifest generation,
            see app/manifest.ts. Removing static manifest link to avoid conflict. */}
