  ...
  default: (props: AppPublisherProps) => {
    ...
    return (
      ...
      >
        ...
        <button type="button" onClick={() => { Promise.resolve(props.onPublish?.({ id: 'test-model-config', model: 'test-model', provider: 'test-provider', parameters: {}, url: '/apps/test/workflows/publish', title: 'Test title', releaseNotes: 'Test notes' })).catch(() => undefined) }}>
