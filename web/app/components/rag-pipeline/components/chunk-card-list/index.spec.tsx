...
describe('ChunkCardList Integration', () => {
  ...
  describe('Complete Workflows', () => {
    ...
    it('should render complete QA chunking workflow', () => {
        ...
        qa_chunks: [
          {
            ...
            answer: 'CheersAI is an open-source LLM application development platform.',
          },
          {
      ...
      expect(screen.getByText('What is CheersAI?')).toBeInTheDocument()
      expect(screen.getByText('CheersAI is an open-source LLM application development platform.')).toBeInTheDocument()
