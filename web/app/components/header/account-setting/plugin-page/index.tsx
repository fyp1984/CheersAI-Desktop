...
const PluginPage = () => {
  ...
  return (
    <div className="pb-7">
      ...
      <div className="fixed bottom-0 flex h-[42px] w-[472px] items-center bg-white text-xs text-gray-500 dark:border-t dark:border-white/10 dark:bg-[#202126] dark:text-gray-400">
