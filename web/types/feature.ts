...
export enum DatasetAttr {
  ...
  DATA_NEXUS_API_PREFIX = 'data-nexus-api-prefix',
  ...
  DATA_PUBLIC_DESKTOP_SSO_LOGIN_URL = 'data-public-desktop-sso-login-url',
  DATA_PUBLIC_DESKTOP_SSO_CLIENT_ID = 'data-public-desktop-sso-client-id',
  DATA_PUBLIC_DESKTOP_SSO_PROTOCOL = 'data-public-desktop-sso-protocol',
  DATA_PUBLIC_DESKTOP_SSO_ENABLED = 'data-public-desktop-sso-enabled',
